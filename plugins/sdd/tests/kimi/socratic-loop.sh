...
# writing it up, on Kimi Code. The Kimi twin of tests/claude/socratic-loop.sh —
...
#
# Usage:
#   tests/kimi/socratic-loop.sh [-n TRIALS] [-m MODEL] [-v] [--no-sync]
...
echo "socratic-loop (kimi): model=$MODEL trials/desc=$TRIALS  descriptions=${#DESCRIPTIONS[@]}"
